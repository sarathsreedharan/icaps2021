  ...
  })(
    {
            ...
            g = (function (a) {
              function b(b) {
                var c = a.call(this) || this,
                  d = b;
                return (
                  d.trigger && (c.trigger = d.trigger),
                  d.kick && (c.kick = d.kick),
                  d.drag && (c.drag = d.drag),
                  d.on && (c.on = d.on),
                  (c.dragstart = c.dragStart = f.Layout.dragStart),
                  (c.dragend = c.dragEnd = f.Layout.dragEnd),
                  c
                );
              }
              return (
      ...
      3: [
        function (a, b, c) {
          ...
          function d(a, b, c, d) {
            return (
              a.cola.start(0, 0, 0, 10, !1),
              e(a.cola.nodes(), a.cola.groups(), c, d).routeEdges(
                a.powerGraph.powerEdges,
                b,
                function (a) {
          ...
          function e(a, b, c, d) {
            a.forEach(function (a) {
              a.routerNode = { name: a.name, bounds: a.bounds.inflate(-c) };
            }),
              b.forEach(function (b) {
                b.routerNode = {
                  bounds: b.bounds.inflate(-d),
                  children: (void 0 !== b.groups
          ...
          function f(a, b, c) {
            ...
            return (
              ...
              d.groups.forEach(function (a) {
                ...
                h.push(a),
                  void 0 !== a.leaves &&
                    a.leaves.forEach(function (a) {
                      return f.push({ source: b, target: a.index });
                    }),
                  void 0 !== a.groups &&
                    a.groups.forEach(function (a) {
                      return f.push({ source: b, target: a.id + e });
                    });
              }),
              d.powerEdges.forEach(function (a) {
                f.push({ source: a.source.index, target: a.target.index });
              }),
              new g.Layout()
                .size(b)
                .nodes(h)
      ...
      4: [
        function (a, b, c) {
          ...
          function d(a) {
            return !a || e(a)
              ? new f.D3StyleLayoutAdaptor()
              : new g.D3StyleLayoutAdaptor(a);
          }
          function e(a) {
            var b = /^3\./;
          ...
          var f = a("./layout"),
            g = (function (a) {
              function b() {
                ...
                b.event = d3.dispatch(
                  f.EventType[f.EventType.start],
                  f.EventType[f.EventType.tick],
                  f.EventType[f.EventType.end]
                );
                var c = b;
                return (
                  (b.drag = function () {
                    if (!a)
                      var a = d3.behavior
                        .drag()
                        .origin(f.Layout.dragOrigin)
                        .on("dragstart.d3adaptor", f.Layout.dragStart)
                        .on("drag.d3adaptor", function (a) {
          ...
          var e = a("./layout"),
            f = (function (a) {
              function b(b) {
                ...
                (c.d3Context = b),
                  (c.event = b.dispatch(
                    e.EventType[e.EventType.start],
                    e.EventType[e.EventType.tick],
                    e.EventType[e.EventType.end]
                  ));
                var d = c;
                return (
                  (c.drag = function () {
                    if (!a)
                      var a = b
                        .drag()
                        .subject(e.Layout.dragOrigin)
                        .on("start.d3adaptor", e.Layout.dragStart)
                        .on("drag.d3adaptor", function (a) {
        ...
        function (a, b, c) {
          ...
          var e = (function () {
            function a(a, b, c) {
              ...
              for (
                this.minD === Number.MAX_VALUE && (this.minD = 1), h = this.k;
                h--;

              ) {
                for (
                  this.g[h] = new Array(e), this.H[h] = new Array(e), g = e;
                  g--;
            ...
            return (
              (a.createSquareMatrix = function (a, b) {
              ...
              (a.prototype.offsetDir = function () {
                for (
                  var a = this, b = new Array(this.k), c = 0, d = 0;
                  d < this.k;
                  ++d
                ) {
                  var e = (b[d] = this.random.getNextBetween(0.01, 1) - 0.5);
                  c += e * e;
                }
                return (
                  (c = Math.sqrt(c)),
              ...
              (a.prototype.computeDerivatives = function (a) {
                ...
                if (!(c < 1)) {
                  ...
                  for (
                    var v = this.snapGridSize / 2,
                      w = this.snapGridSize,
                      x = this.snapStrength,
                      y = x / (v * v),
                      z = this.numGridSnapNodes,
                      i = 0;
                    i < z;
                    ++i
                  )
                    for (d = 0; d < this.k; ++d) {
                      ...
                      -v < m &&
                        ...
                        (this.scaleSnapByMaxH
                          ? ((this.g[d][i] += h * y * m),
                            (this.H[d][i][i] += h * y))
                          : ((this.g[d][i] += y * m), (this.H[d][i][i] += y)));
                    }
                  this.locks.isEmpty() ||
                    this.locks.apply(function (c, e) {
                      for (d = 0; d < b.k; ++d)
                        (b.H[d][c][c] += h),
                          (b.g[d][c] -= h * (e[d] - a[d][c]));
                    });
              ...
              (a.prototype.reduceStress = function () {
                ...
                for (
                  var a = this.computeStepSize(this.g), b = 0;
                  b < this.k;
                  ++b
                )
      ...
      8: [
        function (a, b, c) {
          ...
          function g(a) {
            ...
            var g = b - 1,
              h = [];
            if ((h.push(c[0]), g === e - 1)) c[g].y !== c[0].y && h.push(c[g]);
            else {
              var i,
                j = e - 1,
                k = c[e - 1].x;
              ...
              for (i = b + 1, b = g; ++b <= i; )
                if (!(d(c[0], c[i], c[b]) >= 0 && b < i)) {
                  for (
                    ;
                    h.length > 1 &&
                    !(d(h[h.length - 2], h[h.length - 1], c[b]) > 0);
          ...
          function i(a, b) {
            var c = b.slice(0);
            return c.push(b[0]), { rtan: j(a, c), ltan: k(a, c) };
          }
          function j(a, b) {
            var c,
              d,
          ...
          function q(a, b) {
            for (var c = [], d = 1, e = b.length; d < e; ++d) {
              var f = w.Rectangle.lineIntersection(
                a.x1,
                a.y1,
                a.x2,
                a.y2,
          ...
          function r(a, b) {
            for (
              var c = a.length - 1, e = b.length - 1, f = new B(), g = 0;
              g < c;
              ++g
            )
              for (var h = 0; h < e; ++h) {
          ...
          var F = (function () {
            function a(a, b) {
              if (((this.P = a), (this.V = []), (this.E = []), b))
                (this.V = b.V.slice(0)), (this.E = b.E.slice(0));
              else {
                for (var c = a.length, d = 0; d < c; d++) {
                  ...
                  e.length > 1 &&
                    this.E.push(new E(e[0].vv, e[e.length - 1].vv));
                }
                for (var d = 0; d < c - 1; d++)
            ...
            return (
              (a.prototype.addEdgeIfVisible = function (a, b, c, d) {
                this.intersectsPolys(new y(a.x, a.y, b.x, b.y), c, d) ||
                  this.E.push(new E(a.vv, b.vv));
              }),
              ...
              (a.prototype.intersectsPolys = function (a, b, c) {
                for (var d = 0, e = this.P.length; d < e; ++d)
                  if (d != b && d != c && q(a, this.P[d]).length > 0) return !0;
                return !1;
              }),
              a
            );
      ...
      9: [
            ...
            function a(b, c) {
              ...
              d.length >= f.length
                ...
                : ((this.length = f.length),
                  (this.si = f.si),
                  (this.ti = c.length - f.ti - f.length),
                  (this.reversed = !0));
            }
            return (
              (a.findMatch = function (a, b) {
                for (
                  var c = a.length,
                    d = b.length,
                    e = { length: 0, si: -1, ti: -1 },
                    f = new Array(c),
                    g = 0;
                  g < c;
                  g++
          ...
          var j = (function () {
            function a(a, b, c) {
              ...
              (this.originalnodes = a),
                ...
                this.nodes.forEach(function (a) {
                  void 0 === a.parent &&
                    ((a.parent = e.root), e.root.children.push(a.id)),
                    (a.ports = []);
                }),
              ...
              var f = this.midPoints(
                  this.cols.map(function (a) {
                    return a.pos;
                  })
                ),
                i = this.midPoints(
                  this.rows.map(function (a) {
                    return a.pos;
                  })
                ),
                j = f[0],
                ...
                n = this.rows
                  .map(function (a) {
                    return { x1: j, x2: k, y1: a.pos, y2: a.pos };
                  })
                  .concat(
                    i.map(function (a) {
                      return { x1: j, x2: k, y1: a, y2: a };
                    })
                  ),
                o = this.cols
                  .map(function (a) {
                    return { x1: a.pos, x2: a.pos, y1: l, y2: m };
                  })
                  .concat(
                    f.map(function (a) {
                      return { x1: a, x2: a, y1: l, y2: m };
                    })
                  ),
                p = n.concat(o);
              p.forEach(function (a) {
                ...
                p.forEach(function (a, b) {
                  ...
                  for (var f = 1; f < a.verts.length; f++) {
                    var g = a.verts[f - 1],
                      i = a.verts[f];
                    (g.node && g.node === i.node && g.node.leaf) ||
                      e.edges.push({
                        source: g.id,
                        target: i.id,
            ...
            return (
              ...
              (a.prototype.getGridLines = function (a) {
                for (
                  var b = [], c = this.leaves.slice(0, this.leaves.length);
                  c.length > 0;
              ...
              (a.prototype.findAncestorPathBetween = function (a, b) {
                for (
                  var c = this.findLineage(a), d = this.findLineage(b), e = 0;
                  c[e] === d[e];
              ...
              (a.getSegmentSets = function (a, b, c) {
                ...
                for (var j = [], k = null, l = 0; l < d.length; l++) {
                  var h = d[l];
                  (!k || Math.abs(h[0][b] - k.pos) > 0.1) &&
                    ((k = { pos: h[0][b], segments: [] }), j.push(k)),
                    k.segments.push(h);
                }
                return j;
              }),
              ...
              (a.nudgeSegments = function (b, c, d, e, f) {
                for (
                  var g = a.getSegmentSets(b, c, d), h = 0;
                  h < g.length;
                  h++
                ) {
                  for (
                    ...
                    var l = i.segments[k];
                    j.push({ type: 0, s: l, pos: Math.min(l[0][d], l[1][d]) }),
                      j.push({
                        type: 1,
                        s: l,
              ...
              (a.prototype.routeEdges = function (b, c, d, e) {
                ...
                return (
                  a.nudgeSegments(i, "x", "y", h, c),
                  a.nudgeSegments(i, "y", "x", h, c),
                  a.unreverseEdges(i, g),
                  i
                );
              }),
              ...
              (a.orderEdges = function (b) {
                for (var c = [], d = 0; d < b.length - 1; d++)
                  for (var e = d + 1; e < b.length; e++) {
                    ...
                    0 !== l.length &&
                      (l.reversed &&
                        (k.reverse(), (k.reversed = !0), (l = new i(j, k))),
                      (l.si <= 0 || l.ti <= 0) &&
                      (l.si + l.length >= j.length ||
                        l.ti + l.length >= k.length)
                        ? c.push({ l: d, r: e })
                        : (l.si + l.length >= j.length ||
                          l.ti + l.length >= k.length
                            ? ((f = j[l.si + 1]),
              ...
              (a.prototype.route = function (a, b) {
                ...
                for (var h = 1; h < d.ports.length; h++) {
                  var i = d.ports[0].id,
                    j = d.ports[h].id;
                  this.passableEdges.push({ source: i, target: j, length: 0 });
                }
                ...
                var k = function (a) {
                  ...
                  o = function (a, b, f) {
                    var g = c.verts[a],
                      ...
                      j = Math.abs(i.x - g.x),
                      k = Math.abs(i.y - g.y);
                    return (g.node === d && g.node === h.node) ||
                      (h.node === e && h.node === i.node)
                      ? 0
                      : j > 1 && k > 1
                      ? 1e3
                      : 0;
                  },
                  p = n.PathFromNodeToNodeWithPrevCost(
                    d.ports[0].id,
                    e.ports[0].id,
                    o
                  ),
                ...
                return (
                  q.push(this.nodes[e.id].ports[0]),
                  q.filter(function (a, b) {
                    return !(
                      (b < q.length - 1 &&
                        q[b + 1].node === d &&
                        a.node === d) ||
                      (b > 0 && a.node === e && q[b - 1].node === e)
                    );
                  })
                );
              }),
                ...
                if (b.length > 1)
                  for (var g = 0; g < b.length; g++) {
                    ...
                    if (g < b.length - 1) {
                      ...
                      Math.abs(k) > 0
                        ? ((r = n + (k / Math.abs(k)) * c), (s = o))
                        : ((r = n), (s = o + (l / Math.abs(l)) * c));
                      var u = Math.abs(r - i),
                        v = Math.abs(s - j);
                      f.routepath +=
                        "A " +
        ...
        { "./rectangle": 17, "./shortestpaths": 18, "./vpsc": 19 },
      ],
      10: [
        function (a, b, c) {
          "use strict";
          function d(a, b, c, d, e) {
            ...
            function h(a, b) {
              for (var c = void 0, d = 0; d < s.length; d++)
                if (
                  s[d].space_left >= a.height &&
                  s[d].x + s[d].width + a.width + f.PADDING - b <=
                    f.FLOAT_EPSILON
                ) {
                  c = s[d];
                  break;
              ...
              s.push(a),
                void 0 !== c
                  ? ((a.x = c.x + c.width + f.PADDING),
                    (a.y = c.bottom),
                    (a.space_left = a.height),
                    (a.bottom = a.y),
                    (c.space_left -= a.height + f.PADDING),
                    (c.bottom += a.height + f.PADDING))
                  : ((a.y = r),
                    (r += a.height + f.PADDING),
                    (a.x = k),
                    (a.bottom = a.y),
                    (a.space_left = a.height)),
                a.y + a.height - p > -f.FLOAT_EPSILON &&
                  (p = a.y + a.height - l),
                a.x + a.width - o > -f.FLOAT_EPSILON && (o = a.x + a.width - k);
            }
            function i(a) {
              var b = 0;
              return (
              ...
              (function (a, b) {
                ...
                for (
                  var e = (p = q),
                    ...
                    n = Number.MAX_VALUE,
                    o = Number.MAX_VALUE;
                  n > q || o > f.FLOAT_EPSILON;

                ) {
                  if (1 != m)
                    var p = h - (h - e) / f.GOLDEN_SECTION,
                      k = g(a, p);
                  if (0 != m)
                    var r = e + (h - e) / f.GOLDEN_SECTION,
                      l = g(a, r);
                  if (
                    ((n = Math.abs(p - r)),
                    (o = Math.abs(k - l)),
              ...
              (function (a) {
                a.forEach(function (a) {
                  ...
                  a.array.forEach(function (a) {
                    ...
                    (b.x /= a.array.length),
                    (b.y /= a.array.length);
                  var c = { x: b.x - a.width / 2, y: b.y - a.height / 2 },
                    d = {
                      x: a.x - c.x + m / 2 - o / 2,
                      y: a.y - c.y + n / 2 - p / 2,
                    };
            ...
            function a() {
              ...
              (this._canvasSize = [1, 1]),
                ...
                (this.linkAccessor = {
                  ...
                  getType: function (a) {
                    return "function" == typeof b._linkType
                      ? b._linkType(a)
                      : 0;
                  },
                });
            ...
            return (
              ...
              (a.prototype.tick = function () {
                ...
                return (
                  0 === f
                    ? (this._alpha = 0)
                    : void 0 !== this._lastStress && (this._alpha = f),
                  (this._lastStress = f),
              ...
              (a.prototype.updateNodePositions = function () {
                for (
                  ...
                  (a = this._nodes[d]), (a.x = b[d]), (a.y = c[d]);
              }),
                  ...
                  ? ((this._groups = a),
                    ...
                    this._groups.forEach(function (a) {
                      void 0 === a.padding && (a.padding = 1),
                        void 0 !== a.leaves &&
                          a.leaves.forEach(function (c, d) {
                            "number" == typeof c &&
                              ((a.leaves[d] = b._nodes[c]).parent = a);
                          }),
                        void 0 !== a.groups &&
                          a.groups.forEach(function (c, d) {
                            "number" == typeof c &&
                              ((a.groups[d] = b._groups[c]).parent = a);
                          });
                    }),
              ...
              (a.prototype.constraints = function (a) {
                return arguments.length
                  ? ((this._constraints = a), this)
                  : this._constraints;
              }),
              (a.prototype.distanceMatrix = function (a) {
                return arguments.length
                  ? ((this._distanceMatrix = a), this)
              ...
              (a.prototype.convergenceThreshold = function (a) {
                return a
                  ? ((this._threshold = "function" == typeof a ? a : +a), this)
                  : this._threshold;
              }),
              ...
              (a.prototype.getLinkType = function (a) {
                return "function" == typeof this._linkType
                  ? this._linkType(a)
                  : 0;
              }),
              (a.prototype.symmetricDiffLinkLengths = function (a, b) {
                ...
                return (
                  void 0 === b && (b = 1),
                  this.linkDistance(function (b) {
                    return a * b.length;
                  }),
                  (this._linkLengthCalculator = function () {
                    return g.symmetricDiffLinkLengths(
                      c._links,
                      c.linkAccessor,
                      b
                    );
              ...
              (a.prototype.start = function (b, c, d, e, f) {
                var k = this;
                void 0 === b && (b = 0),
                  void 0 === c && (c = 0),
                  void 0 === d && (d = 0),
                ...
                var l,
                  m = this.nodes().length,
                  n = m + 2 * this._groups.length,
                  o = (this._links.length, this._canvasSize[0]),
                  p = this._canvasSize[1],
                  q = new Array(n),
                  r = new Array(n),
                  s = null,
                  t = this._avoidOverlaps;
                this._nodes.forEach(function (a, b) {
                  (a.index = b),
                    void 0 === a.x && ((a.x = o / 2), (a.y = p / 2)),
                    (q[b] = a.x),
                    (r[b] = a.y);
                }),
                ...
                this._distanceMatrix
                  ...
                  : ((u = new j.Calculator(
                      ...
                      a.getTargetIndex,
                      function (a) {
                        return k.getLinkLength(a);
                      }
                    ).DistanceMatrix()),
                    (s = h.Descent.createSquareMatrix(n, function () {
                      return 2;
                    })),
                    this._links.forEach(function (a) {
                      "number" == typeof a.source &&
                        (a.source = k._nodes[a.source]),
                        "number" == typeof a.target &&
                          (a.target = k._nodes[a.target]);
                    }),
                    this._links.forEach(function (b) {
                      var c = a.getSourceIndex(b),
                        d = a.getTargetIndex(b);
                      s[c][d] = s[d][c] = b.weight || 1;
                    }));
                var v = h.Descent.createSquareMatrix(n, function (a, b) {
                  return u[a][b];
                });
                if (this._rootGroup && void 0 !== this._rootGroup.groups) {
                  var l = m,
                    w = function (a, b, c, d) {
                      (s[a][b] = s[b][a] = c), (v[a][b] = v[b][a] = d);
                    };
                  this._groups.forEach(function (a) {
                    w(l, l + 1, k._groupCompactness, 0.1),
                      (q[l] = 0),
                      (r[l++] = 0),
                      (q[l] = 0),
                      (r[l++] = 0);
                ...
                var x = this._constraints || [];
                this._directedLinkConstraints &&
                  ((this.linkAccessor.getMinSeparation = this._directedLinkConstraints.getMinSeparation),
                  (x = x.concat(
                    g.generateDirectedEdgeConstraints(
                      m,
                      this._links,
                  ...
                  (this._descent = new h.Descent([q, r], v)),
                ...
                for (var l = 0; l < m; ++l) {
                  ...
                  if (y.fixed) {
                    (y.px = y.x), (y.py = y.y);
                    var z = [y.x, y.y];
                    this._descent.locks.add(l, z);
                  }
                }
                if (
                  ((this._descent.threshold = this._threshold),
                  this.initialLayout(b, q, r),
                  x.length > 0 &&
                    (this._descent.project = new i.Projection(
                      this._nodes,
                      this._groups,
                      this._rootGroup,
                      x
                  ...
                  this._descent.run(c),
                  this.separateOverlappingComponents(o, p),
                  this.avoidOverlaps(t),
                  t &&
                    (this._nodes.forEach(function (a, b) {
                      (a.x = q[b]), (a.y = r[b]);
                    }),
                  ...
                  (this._descent.snapStrength = 1e3),
                    ...
                    (this._descent.numGridSnapNodes = m),
                    (this._descent.scaleSnapByMaxH = m != n);
                  var A = h.Descent.createSquareMatrix(n, function (a, b) {
                    return a >= m || b >= m ? s[a][b] : 0;
                  });
                  (this._descent.G = A), this._descent.run(e);
                }
                return (
                  this.updateNodePositions(),
                  this.separateOverlappingComponents(o, p),
                ...
                if (this._groups.length > 0 && b > 0) {
                  var e = this._nodes.length,
                    f = this._links.map(function (a) {
                      return { source: a.source.index, target: a.target.index };
                    }),
                    g = this._nodes.map(function (a) {
                      return { index: a.index };
                    });
                  this._groups.forEach(function (a, b) {
                    g.push({ index: (a.index = e + b) });
                  }),
                    this._groups.forEach(function (a, b) {
                      void 0 !== a.leaves &&
                        a.leaves.forEach(function (b) {
                          return f.push({ source: a.index, target: b.index });
                        }),
                        void 0 !== a.groups &&
              ...
              (a.prototype.separateOverlappingComponents = function (a, b) {
                var c = this;
                if (!this._distanceMatrix && this._handleDisconnected) {
                  var d = this._descent.x[0],
                    e = this._descent.x[1];
                  this._nodes.forEach(function (a, b) {
                    (a.x = d[b]), (a.y = e[b]);
                  });
                  var f = l.separateGraphs(this._nodes, this._links);
                  l.applyPacking(f, a, b, this._defaultNodeSize),
                    this._nodes.forEach(function (a, b) {
                      (c._descent.x[0][b] = a.x),
                        (c._descent.x[1][b] = a.y),
                        a.bounds &&
                          (a.bounds.setXCentre(a.x), a.bounds.setYCentre(a.y));
                    });
                }
              }),
              ...
              (a.prototype.prepareEdgeRouting = function (a) {
                void 0 === a && (a = 0),
                  (this._visibilityGraph = new k.TangentVisibilityGraph(
                    this._nodes.map(function (b) {
              ...
              (a.prototype.routeEdge = function (a, b, c) {
                ...
                var d = [],
                  ...
                  f = { x: a.source.x, y: a.source.y },
                  g = { x: a.target.x, y: a.target.y },
                ...
                if (1 === q.length || q.length === e.V.length) {
                  var r = i.makeEdgeBetween(
                    a.source.innerBounds,
                    a.target.innerBounds,
                    b
                  );
                  ...
                  for (
                    var s = q.length - 2,
                      t = e.V[q[s]].p,
                      u = e.V[q[0]].p,
                      d = [a.source.innerBounds.rayIntersection(t.x, t.y)],
                      v = s;
                    v >= 0;
                    --v
                  )
              ...
              (a.dragStart = function (b) {
                d(b)
                  ? a.storeOffset(b, a.dragOrigin(b))
                  : (a.stopNode(b), (b.fixed |= 2));
              }),
              ...
              (a.storeOffset = function (b, c) {
                void 0 !== b.leaves &&
                  ...
                  void 0 !== b.groups &&
                    b.groups.forEach(function (b) {
                      return a.storeOffset(b, c);
                    });
              }),
              (a.dragOrigin = function (a) {
                return d(a) ? { x: a.bounds.cx(), y: a.bounds.cy() } : a;
              }),
              (a.drag = function (b, c) {
                d(b)
                  ? (void 0 !== b.leaves &&
                      b.leaves.forEach(function (a) {
              ...
              (a.dragEnd = function (b) {
                d(b)
                  ? (void 0 !== b.leaves &&
                    ...
                    void 0 !== b.groups && b.groups.forEach(a.dragEnd))
                  : (b.fixed &= -7);
              }),
        ...
        function (a, b, c) {
          ...
          var d = a("./shortestpaths"),
            ...
            h = (function () {
              ...
              return (
                (a.prototype.actualLength = function (a) {
                  var b = this;
                  return Math.sqrt(
          ...
          var j = (function () {
            ...
            return (
              (a.prototype.linkLength = function (a) {
              ...
              (a.prototype.start = function (a) {
                ...
                this.links.forEach(function (a) {
                  ...
                  (this.descent.G = l),
                  this.constraints &&
                    (this.descent.project = new f.Projection(
                      this.nodes,
                      null,
                      null,
                      this.constraints
          ...
          var k = (function () {
            function a() {}
            return (
              (a.prototype.getSourceIndex = function (a) {
                return a.source;
              }),
          ...
          function k(a, b, c) {
            function d(a) {
              ...
              for (var b = 0, c = a.out; b < c.length; b++) {
                var e = c[b];
                void 0 === e.index
                  ? (d(e), (a.lowlink = Math.min(a.lowlink, e.lowlink)))
                  : e.onStack && (a.lowlink = Math.min(a.lowlink, e.index));
              }
              if (a.lowlink === a.index) {
                for (
                  var i = [];
                  g.length &&
                  ((e = g.pop()), (e.onStack = !1), i.push(e), e !== a);
      ...
      14: [
        function (a, b, c) {
          ...
          function d(a, b, c) {
            a.forAll(function (a) {
              if (a.isLeaf()) b.leaves || (b.leaves = []), b.leaves.push(a.id);
              else {
                var e = b;
                if (((a.gid = c.length), !a.isIsland() || a.isPredefined())) {
                  if (((e = { id: a.gid }), a.isPredefined()))
                    for (var f in a.definition) e[f] = a.definition[f];
          ...
          var h = (function () {
            ...
            return (
              (a.prototype.initModulesFromGroup = function (a) {
                var b = new j();
                this.roots.push(b);
              ...
              (a.prototype.merge = function (a, b, c) {
                ...
                return (
                  h(e, "incoming", "outgoing"),
                  h(d, "outgoing", "incoming"),
                  (this.R -= d.count() + e.count()),
                  this.roots[c].remove(a),
                  this.roots[c].remove(b),
                  this.roots[c].add(g),
                  g
                );
              }),
              (a.prototype.rootMerges = function (a) {
                ...
                for (
                  ...
                  for (var h = f + 1; h < c; ++h) {
                    var i = b[f],
                      j = b[h];
                    (d[e] = { id: e, nEdges: this.nEdges(i, j), a: i, b: j }),
                      e++;
                  }
                return d;
              }),
              ...
              (a.prototype.getGroupHierarchy = function (a) {
                ...
                return (
                  d(this.roots[0], e, c),
                  this.allEdges().forEach(function (d) {
                    var e = b.modules[d.source],
                      f = b.modules[d.target];
                    a.push(
                      new g(
                        void 0 === e.gid ? d.source : c[e.gid],
                        void 0 === f.gid ? d.target : c[f.gid],
                        d.type
                      )
                    );
                  }),
          ...
          var i = (function () {
            ...
            return (
              (a.prototype.getEdges = function (a) {
                var b = this;
              ...
              (a.prototype.isIsland = function () {
                return (
                  0 === this.outgoing.count() && 0 === this.incoming.count()
                );
              }),
          ...
          var k = (function () {
            ...
            return (
              ...
              (a.prototype.add = function (a, b) {
                (a in this.sets ? this.sets[a] : (this.sets[a] = new j())).add(
                  b
                ),
                  ++this.n;
              }),
          ...
          var d = (function () {
            ...
            return (
              ...
              (a.prototype.forEach = function (a) {
                this.empty() ||
                  (a(this.elem, this),
                  this.subheaps.forEach(function (b) {
                    return b.forEach(a);
                  }));
              }),
              (a.prototype.count = function () {
                return this.empty()
                  ? 0
                  : 1 +
                      this.subheaps.reduce(function (a, b) {
                        return a + b.count();
                      }, 0);
              }),
              ...
              (a.prototype.merge = function (a, b) {
                return this.empty()
                  ...
                  ? this
                  : b(this.elem, a.elem)
                  ? (this.subheaps.push(a), this)
                  : (a.subheaps.push(this), a);
              }),
                ...
                for (var c, e, f = 0; (e = a[f]); ++f)
                  (c = new d(e)),
                    (this.root = this.empty()
                      ? c
                      : this.root.merge(c, this.lessThan));
                return c;
              }),
              (a.prototype.empty = function () {
      ...
      16: [
        function (a, b, c) {
          ...
          var g = (function () {
              ...
              return (
                (a.prototype.get_child = function (a) {
            ...
            h = (function (a) {
              ...
              return (
                ...
                (b.prototype.insert = function (a) {
                  var c = !1;
                  if (null === this._root)
                    (this._root = new g(a)), (c = !0), this.size++;
                  else {
                    var d = new g(void 0),
                      e = !1,
                      f = !1,
                      ...
                      if (
                        (null === k
                          ...
                          : b.is_red(k.left) &&
                            ...
                            (k.left.red = !1),
                            (k.right.red = !1)),
                        b.is_red(k) && b.is_red(j))
                      ) {
                        var l = i.right === h;
                        k === j.get_child(f)
                          ? i.set_child(l, b.single_rotate(h, !f))
                          : i.set_child(l, b.double_rotate(h, !f));
                      }
                ...
                (b.prototype.remove = function (a) {
                  ...
                  for (
                    ...
                    if (
                      ((i = k > 0),
                      0 === k && (h = d),
                      !b.is_red(d) && !b.is_red(d.get_child(i)))
                    )
                      if (b.is_red(d.get_child(!i))) {
                        ...
                        if (null !== m)
                          if (
                            b.is_red(m.get_child(!j)) ||
                            b.is_red(m.get_child(j))
                          ) {
                            var n = f.right === e;
                            b.is_red(m.get_child(j))
                              ? f.set_child(n, b.double_rotate(e, j))
                              : b.is_red(m.get_child(!j)) &&
                                f.set_child(n, b.single_rotate(e, j));
                            var o = f.get_child(n);
                            (o.red = !0),
                              (d.red = !0),
                              (o.left.red = !1),
                  ...
                  return (
                    null !== h &&
                      ((h.data = d.data),
                      e.set_child(e.right === d, d.get_child(null === d.left)),
                      this.size--),
                    (this._root = c.right),
                ...
                (b.double_rotate = function (a, c) {
                  return (
                    a.set_child(!c, b.single_rotate(a.get_child(!c), !c)),
                    b.single_rotate(a, c)
                  );
                }),
                b
        ...
        function (a, b, c) {
          ...
          function d(a) {
            return (
              (a.bounds =
                void 0 !== a.leaves
                  ? a.leaves.reduce(function (a, b) {
                      return b.bounds.union(a);
                    }, u.empty())
                  : u.empty()),
              void 0 !== a.groups &&
                (a.bounds = a.groups.reduce(function (a, b) {
                  return d(b).union(a);
                }, a.bounds)),
              (a.bounds = a.bounds.inflate(a.padding)),
              a.bounds
            );
          }
          function e(a, b, c) {
            var d = a.rayIntersection(b.cx(), b.cy()) || {
              ...
              e = b.rayIntersection(a.cx(), a.cy()) || { x: b.cx(), y: b.cy() },
              f = e.x - d.x,
              g = e.y - d.y,
              h = Math.sqrt(f * f + g * g),
              i = h - c;
            return {
              ...
              arrowStart: { x: d.x + (i * f) / h, y: d.y + (i * g) / h },
            };
          }
          function f(a, b, c) {
            ...
            var e = d.x - a.x,
              f = d.y - a.y,
              g = Math.sqrt(e * e + f * f);
            return { x: d.x - (c * e) / g, y: d.y - (c * f) / g };
          }
          function g(a, b) {
            return a.pos > b.pos
              ? 1
          ...
          function j(a, b, c, d) {
            ...
            for (e = 0; e < i; ++e) {
              var o = j[e],
                l = o.v;
              if (o.isOpen) n.insert(l), c.findNeighbours(l, n);
              else {
                n.remove(l);
                var p = function (a, b) {
          ...
          function k(a, b) {
            var c = function (c, d) {
              for (var e, f = b.findIter(a); null !== (e = f[c]()); ) {
                ...
                if (
                  ((g <= 0 || g <= e.r.overlapY(a.r)) &&
                    (a[c].insert(e), e[d].insert(a)),
                  g <= 0)
                )
                  break;
              }
          ...
          var A = (function () {
            function a(a, b, c, e, f) {
              ...
              if (
                ...
                (this.groups = b),
                (this.rootGroup = c),
                (this.avoidOverlaps = f),
                (this.variables = a.map(function (a, b) {
                  return (a.variable = new z(b, 1));
                })),
                e && this.createConstraints(e),
                f && c && void 0 !== c.groups)
              ) {
                a.forEach(function (a) {
                  if (!a.width || !a.height)
                ...
                var h = a.length;
                b.forEach(function (a) {
                  (g.variables[h] = a.minVar = new z(
                    h++,
                    void 0 !== a.stiffness ? a.stiffness : 0.01
                  )),
                    (g.variables[h] = a.maxVar = new z(
                      h++,
                      void 0 !== a.stiffness ? a.stiffness : 0.01
                    ));
                });
            ...
            return (
              (a.prototype.createSeparation = function (a) {
                return new s.Constraint(
                  this.nodes[a.left].variable,
                  this.nodes[a.right].variable,
                  a.gap,
                  void 0 !== a.equality && a.equality
                );
              }),
              ...
              (a.prototype.setupVariablesAndBounds = function (a, b, c, d) {
                this.nodes.forEach(function (e, f) {
                  e.fixed
                    ? ((e.variable.weight = e.fixedWeight
                        ? e.fixedWeight
                        : 1e3),
                      (c[f] = d(e)))
                    : (e.variable.weight = 1);
              ...
              (a.prototype.xProject = function (a, b, c) {
                (this.rootGroup || this.avoidOverlaps || this.xConstraints) &&
                  this.project(
                    ...
                    o,
                    function (a) {
                      return a.bounds.setXCentre(
                        (c[a.variable.index] = a.variable.position())
                      );
                    },
                    function (a) {
              ...
              (a.prototype.project = function (a, b, c, e, f, g, h, i, j) {
                this.setupVariablesAndBounds(a, b, e, f),
                  this.rootGroup &&
                    this.avoidOverlaps &&
                    (d(this.rootGroup), (g = g.concat(h(this.rootGroup)))),
                  this.solve(this.variables, g, c, e),
                  this.nodes.forEach(i),
                  this.rootGroup &&
                    this.avoidOverlaps &&
                    (this.groups.forEach(j), d(this.rootGroup));
              }),
        ...
        function (a, b, c) {
          ...
          var d = a("./pqueue"),
            ...
            h = (function () {
              ...
              return (
                (a.prototype.DistanceMatrix = function () {
                ...
                (a.prototype.PathFromNodeToNodeWithPrevCost = function (
                  a,
                  b,
                  c
                ) {
                  ...
                  for (
                    e.push(h);
                    !e.empty() && ((h = e.pop()), (f = h.node), f.id !== b);
                ...
                (a.prototype.dijkstraNeighbours = function (a, b) {
                  void 0 === b && (b = -1);
                  for (
                    var c = new d.PriorityQueue(function (a, b) {
                        return a.d <= b.d;
                      }),
                      e = this.neighbours.length,
                      f = new Array(e);
                    e--;
                  ...
                  for (; !c.empty(); ) {
                    ...
                    for (e = h.neighbours.length; e--; ) {
                      var k = h.neighbours[e],
                        ...
                        l = h.d + k.distance;
                      h.d !== Number.MAX_VALUE &&
                        j.d > l &&
                        ((j.d = l),
                        (j.prev = h),
                        c.reduceKey(j.q, j, function (a, b) {
                          return (a.q = b);
                        }));
                    }
                  }
      ...
      19: [
        function (a, b, c) {
          ...
          function d(a, b, c) {
            ...
            return (
              b &&
                ((q = new g(b, 1e3 * m.weight)),
                d.push(q),
                e.push(new f(q, m, o))),
              c &&
                ((r = new g(c, 1e3 * n.weight)),
                d.push(r),
                e.push(new f(n, r, p))),
              new j(d, e).solve(),
              {
          ...
          var e = (function () {
            ...
            return (
              (a.prototype.addVariable = function (a) {
          ...
          var g = (function () {
            ...
            return (
              (a.prototype.dfdv = function () {
                return (
                  2 * this.weight * (this.position() - this.desiredPosition)
                );
              }),
              (a.prototype.position = function () {
                return (
                  (this.block.ps.scale * this.block.posn + this.offset) /
                  this.scale
                );
              }),
            ...
            return (
              ...
              (a.prototype.compute_lm = function (a, b, c) {
                var d = this,
                  e = a.dfdv();
                return (
                  a.visitNeighbours(b, function (b, f) {
                    var g = d.compute_lm(f, a, c);
                    f === b.right
                      ? ((e += g * b.left.scale), (b.lm = g))
                      : ((e += g * b.right.scale), (b.lm = -g)),
                      c(b);
                  }),
                  e / a.scale
                );
              ...
              (a.prototype.findMinLM = function () {
                var a = null;
                return (
                  this.compute_lm(this.vars[0], null, function (b) {
              ...
              (a.prototype.findMinLMBetween = function (a, b) {
                ...
                var c = null;
                return (
                  this.findPath(a, null, b, function (a, b) {
                    !a.equality &&
                      a.right === b &&
                      (null === c || a.lm < c.lm) &&
                      (c = a);
              ...
              (a.prototype.findPath = function (a, b, c, d) {
                var e = this,
                  f = !1;
                return (
                  a.visitNeighbours(b, function (b, g) {
                    f ||
                      (g !== c && !e.findPath(g, a, c, d)) ||
                      ((f = !0), d(b, g));
                  }),
                  f
                );
              ...
              (a.split = function (b) {
                return (
                  (b.active = !1),
                  [a.createSplitBlock(b.left), a.createSplitBlock(b.right)]
                );
              }),
              ...
              (a.prototype.splitBetween = function (b, c) {
                ...
                if (null !== d) {
                  var e = a.split(d);
                  return { constraint: d, lb: e[0], rb: e[1] };
                }
                return null;
              }),
          ...
          var i = (function () {
            ...
            return (
              ...
              (a.prototype.remove = function (a) {
                ...
                (this.list.length = b),
                  a !== c &&
                    ((this.list[a.blockInd] = c), (c.blockInd = a.blockInd));
              }),
              (a.prototype.merge = function (a) {
                var b = a.left.block,
                  c = a.right.block,
                  d = a.right.offset - a.left.offset - a.gap;
                b.vars.length < c.vars.length
                  ? (c.mergeAcross(b, a, d), this.remove(b))
                  : (b.mergeAcross(c, a, -d), this.remove(c));
              }),
              (a.prototype.forEach = function (a) {
                this.list.forEach(a);
              }),
              ...
              (a.prototype.split = function (a) {
                ...
                this.updateBlockPositions(),
                  this.list.forEach(function (c) {
                    var d = c.findMinLM();
                    null !== d &&
                      d.lm < j.LAGRANGIAN_TOLERANCE &&
                      ((c = d.left.block),
                      h.split(d).forEach(function (a) {
                        return b.insert(a);
                      }),
                      b.remove(c),
                      a.push(d));
          ...
          var j = (function () {
            ...
            return (
              ...
              (a.prototype.mostViolated = function () {
                ...
                return (
                  f !== e &&
                    ((b < a.ZERO_UPPERBOUND && !c.active) || c.equality) &&
                    ((d[f] = d[e - 1]), (d.length = e - 1)),
                  c
                );
              }),
              (a.prototype.satisfy = function () {
                ...
                for (
                  var b = null;
                  (b = this.mostViolated()) &&
                  (b.equality || (b.slack() < a.ZERO_UPPERBOUND && !b.active));

                ) {
                  var c = b.left.block;
                  if (c !== b.right.block) this.bs.merge(b);
                  else {
              ...
              (a.prototype.solve = function () {
                this.satisfy();
                for (
                  var a = Number.MAX_VALUE, b = this.bs.cost();
                  Math.abs(a - b) > 1e-4;

                )
                  this.satisfy(), (a = b), (b = this.bs.cost());
                return b;
              }),
              (a.LAGRANGIAN_TOLERANCE = -1e-4),
              (a.ZERO_UPPERBOUND = -1e-10),
              a
            );
          })();
