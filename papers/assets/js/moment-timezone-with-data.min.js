!(function (c, M) {
  ...
  function z(c) {
    ...
    for (M = 0; M < z.length; M++) (b /= 60), (a += O(z.charCodeAt(M)) * b);
    return a * p;
  }
  function L(c) {
  ...
  function u(c, M) {
    var A, o;
    for (L(M), A = 0; A < M.length; A++)
      (o = M[A]), (e[o] = e[o] || {}), (e[o][c] = !0);
  }
  function l() {
    try {
    ...
    var A,
      ...
      b = (function () {
        var c,
          ...
          b = [z];
        for (A = 1; A < 48; A++)
          (M = new W(new Date(o, A, 1))).offset !== z.offset &&
            ((c = X(z, M)), b.push(c), b.push(new W(new Date(c.at + 6e4)))),
            (z = M);
        for (A = 0; A < 4; A++)
  ...
  function s(c, M) {
    ...
    return o instanceof N
      ...
      ? ((o = new N(o)), (a[c] = o))
      : p[c] && M !== s && (A = s(p[c], s))
      ? ((o = a[c] = new N())._set(A), (o.name = i[c]), o)
      : null;
  }
  function E(c) {
    var M, A, o, z;
  ...
  function R(c) {
    ...
    return (
      o && !b.isMoment(c) && C(z) && z.add(o.parse(z), "minutes"), z.tz(A), z
    );
  }
  (A < 2 || (2 == A && o < 6)) &&
    S(
      ...
      parse: function (c) {
        ...
        for (z = 0; z < n; z++)
          if (
            ...
            (A = a[z + 1]),
            (o = a[z ? z - 1 : z]),
            M < A && R.moveAmbiguousForward
              ? (M = A)
              : o < M && R.moveInvalidForward && (M = o),
            b < p[z] - 6e4 * M)
          )
            return a[z];
        return a[n];
    ...
    (R.zonesForCountry = function (c, M) {
      ...
      return M
        ? A.map(function (c) {
            return { name: c, offset: s(c).utcOffset(new Date()) };
          })
        : A;
    });
  var P,
  ...
  (b.tz = R),
      ...
      if (
        (void 0 === c._z &&
          (o &&
            C(c) &&
            !c._isUTC &&
            ((c._d = b.utc(c._a)._d), c.utc().add(o.parse(c), "minutes")),
          (c._z = o)),
        c._z)
      )
        if (
    ...
    (g.utcOffset =
      ...
      function () {
        return (
          0 < arguments.length && (this._z = null), P.apply(this, arguments)
        );
      })),
