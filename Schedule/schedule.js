...
var app = new Vue({
  ...
  data: {
    ...
    Week2: [
      [
        ...
        { type: "session", num: 1, time: 1, end: 2, chairs: "Eli Boyarski" },
        { type: "session", num: 2, time: 2, end: 3, chairs: "Simone Fratini"},
        { type: "session", num: 3, time: 3, end: 4, chairs: "Pascal Bercher"},
        { type: "Socializing", time: 4, end: 6 },
        { type: "gather", time: 6, end: 7 },
        { type: "session", num: 4, time: 7, end: 8, chairs: "Ron Alford" },
        { type: "session", num: 5, time: 8, timeMin: 0, end: 8, endMin: 45, chairs: "Sriraam Natarajan", type2: "Opening Remarks", time2: 8, timeMin2: 45, end2: 9, endMin2: 0},
        { type: "Invited Talk", time: 9, end: 10 },
        { type: "Industry Talks", time: 10, end: 12 },
        { type: "Socializing", time: 12, end: 14 },
        { type: "session", num: 1, time: 14, end: 15, chairs: "Hang Ma" },
        { type: "session", num: 2, time: 15, end: 16, chairs: "Stephen Smith" },
        { type: "session", num: 3, time: 16, end: 17, chairs: "Pascal Bercher" },
        { type: "gather", time: 17, end: 18 },
        { type: "Socializing", time: 18, end: 20 },
        { type: "session", num: 4, time: 20, end: 21, chairs: "Nathan Sturtevant" },
        { type: "session", num: 5, time: 21, end: 22, chairs: "Felipe Trevizan" },
        { type: "gather", time: 22, end: 23 },
      ],
      [
        { day: 10, type: "gather", time: 0, end: 1 },
        { type: "session", num: 6, time: 1, end: 2, chairs: "Vidal Alcázar" },
        { type: "session", num: 7, time: 2, end: 3, chairs: "Ronen Brafman" },
        { type: "session", num: 8, time: 3, end: 4, chairs: "Gregor Behnke" },
        { type: "Socializing", time: 4, end: 6 },
        { type: "gather", time: 6, end: 7 },
        { type: "session", num: 9, time: 7, end: 8, chairs: "Sofia Lemons" },
        { type: "Competitions", time: 8, end: 11 },
        { type: "Invited Talk", time: 11, end: 12 },
        { type: "Socializing", time: 12, end: 14 },
        { type: "session", num: 7, time: 14, end: 15, chairs: "Shirin Sohrabi" },
        { type: "session", num: 6, time: 15, end: 16, chairs: "Oren Salzman" },
        { type: "session", num: 8, time: 16, end: 17, chairs: "Hector Palacios" },
        { type: "gather", time: 17, end: 18 },
        { type: "Socializing", time: 18, end: 20 },
        { type: "session", num: 9, time: 20, end: 21, chairs: "Mark Boddy" },
        { type: "gather", time: 21, end: 23 },
      ],
      [
        { day: 11, type: "gather", time: 0, end: 1 },
        { type: "gather", num: 10, time: 1, tiemMin:0, end: 1, endMin:15, type2:"session", time2:1, timeMin2: 15, end2: 2, endMin2: 0, chairs: "Alberto Finzi" },
        { type: "session", num: 11, time: 2, end: 3, chairs: "AndreA Orlandini" },
        { type: "session", num: 12, time: 3, end: 4, chairs: "Roman Barták" },
        { type: "Socializing", time: 4, end: 6 },
        { type: "gather", time: 6, end: 7 },
        ...
        { type: "session", num: 10, time: 16, timeMin:0, end: 16, endMin:45, chairs: "Stephen Smith"},
        { type: "gather", time: 17, end: 18 },
        { type: "Socializing", time: 18, end: 20 },
        { type: "session", num: 13, time: 20, end: 21, chairs: "Patrik Haslum" },
        { type: "session", num: 14, time: 21, end: 22, chairs: "Pradeep Varakantham" },
        { type: "gather", time: 22, end: 23 },
      ],
      [
        { day: 12, type: "gather", time: 0, end: 1 },
        { type: "session", num: 15, time: 1, end: 2, chairs: "Erez Karpas" },
        { type: "session", num: 16, time: 2, end: 3, chairs: "Antonin Komenda" },
        { type: "session", num: 17, time: 3, end: 4, chairs: "Alvaro Torralba" },
        { type: "Socializing", time: 4, end: 6 },
        { type: "gather", time: 6, end: 7 },
        { type: "session", num: 18, time: 7, end: 8, chairs: "Nir Lipovetzky" },
        { type: "Community Meeting", time: 8, end: 10 },
        { type: "Community Socializing", time: 10, end: 12 },
        { type: "Socializing", time: 12, end: 14 },
        { type: "session", num: 15, time: 14, end: 15, chairs: "Florian Pommerening" },
        { type: "session", num: 16, time: 15, end: 16, chairs: "Florian Pommerening" },
        { type: "session", num: 17, time: 16, end: 17, chairs: "Gregor Behnke" },
        { type: "gather", time: 17, end: 18 },
        { type: "Socializing", time: 18, end: 20 },
        { type: "session", num: 18, time: 20, end: 21, chairs: "Mark Boddy" },
        { type: "gather", time: 21, end: 23 },
      ],
      [
        { day: 13, type: "gather", time: 0, end: 1 },
        { type: "gather", num: 19, time: 1, tiemMin:0, end: 2, endMin:30, type2:"session", time2:1, timeMin2: 30, end2: 2, endMin2: 0, chairs: "Enrico Scala" },
        { type: "session", num: 20, time: 2, end: 3, chairs: "Zongzhang Zhang" },
        { type: "session", num: 21, time: 3, end: 4, chairs: "Vicenç Gómez" },
        { type: "Socializing", time: 4, end: 6 },
        { type: "gather", time: 6, end: 7 },
        { type: "session", num: 22, time: 7, end: 8, chairs: "Erez Karpas" },
        { type: "session", num: 23, time: 8, end: 9, chairs: "Zongzhang Zhang" },
        { type: "Posters", time: 9, end: 11 },
        { type: "Invited Talk", time: 11, end: 12 },
        { type: "Socializing", time: 12, end: 14 },
        { type: "gather", num: 19, time: 14, tiemMin:0, end: 15, endMin:30, chairs: "Shirin Sohrabi", type2:"session", time2:14, timeMin2: 30, end2: 15, endMin2: 0 },
        { type: "session", num: 20, time: 15, end: 16, chairs: "Hector Palacios" },
        { type: "session", num: 21, time: 16, end: 17, chairs: "Hector Palacios" },
        { type: "gather", time: 17, end: 18 },
        { type: "Socializing", time: 18, end: 20 },
        { type: "session", num: 22, time: 20, end: 21, chairs: "Mark Boddy" },
        { type: "session", num: 23, time: 21, end: 22, chairs: "Scott Sanner" },
        { type: "gather", time: 22, end: 23 },
      ],
    ],
    modal_sessionNum: "",
  ...
  methods: {
	...
	styleType: function (type) {
		if (type == 'session'){
			return "background-color: #eff7eb;"
		}
		else if (type == 'gather'){
			return "background-color: #bbdfff;"
		}
		else if (type == 'Socializing'){
			return "background-color: #ced5df;"
		}
		else{
			return "background-color: #ffeac5;"
		}
	},
	...
	setModalDetailMin: function (num, type, date, time, timeMin, end, endMin, chairs) {
		this.modal_sessionNum = num.toString();
		this.modal_type = type;
		this.modal_date = date;
		this.modal_time = time;
